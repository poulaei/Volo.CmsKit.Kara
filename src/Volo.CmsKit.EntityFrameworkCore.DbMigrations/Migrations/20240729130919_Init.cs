    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CmsBox", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoxType = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CmsBoxItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CmsBoxItems_CmsBox_BoxId",
                        column: x => x.BoxId,
                        principalTable: "CmsBox",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CmsBox_Section_Status",
                table: "CmsBox",
                columns: new[] { "Section", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_CmsBoxItems_BoxId",
                table: "CmsBoxItems",
                column: "BoxId");
