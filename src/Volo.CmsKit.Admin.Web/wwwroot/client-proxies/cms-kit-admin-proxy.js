...
(function(){
  ...
  // controller volo.cmsKit.admin.galleryImages.galleryImagesAdmin

  (function(){

    abp.utils.createNamespace(window, 'volo.cmsKit.admin.galleryImages.galleryImagesAdmin');

    volo.cmsKit.admin.galleryImages.galleryImagesAdmin.create = function(input, ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/cms-kit-admin/imagegallery',
        type: 'POST',
        data: JSON.stringify(input)
      }, ajaxParams));
    };

    volo.cmsKit.admin.galleryImages.galleryImagesAdmin.get = function(id, ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/cms-kit-admin/imagegallery/' + id + '',
        type: 'GET'
      }, ajaxParams));
    };

    volo.cmsKit.admin.galleryImages.galleryImagesAdmin.getDetailedList = function(ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/cms-kit-admin/imagegallery/GetDetailedList',
        type: 'GET'
      }, ajaxParams));
    };

    volo.cmsKit.admin.galleryImages.galleryImagesAdmin.getList = function(input, ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/cms-kit-admin/imagegallery' + abp.utils.buildQueryString([{ name: 'filter', value: input.filter }, { name: 'sorting', value: input.sorting }, { name: 'skipCount', value: input.skipCount }, { name: 'maxResultCount', value: input.maxResultCount }, { name: 'extraProperties', value: input.extraProperties }]) + '',
        type: 'GET'
      }, ajaxParams));
    };

    volo.cmsKit.admin.galleryImages.galleryImagesAdmin.update = function(id, input, ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/cms-kit-admin/imagegallery/' + id + '',
        type: 'POST',
        data: JSON.stringify(input)
    ...
    volo.cmsKit.admin.galleryImages.galleryImagesAdmin['delete'] = function(id, ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/cms-kit-admin/imagegallery/' + id + '',
        type: 'DELETE',
        dataType: null
