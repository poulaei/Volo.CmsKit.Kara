...
$(function () {
    ...
    var menuService = volo.cmsKit.admin.contentBoxes.contentBoxAdmin;// volo.cmsKit.admin.menus.menuItemAdmin;
    ...
    var menuTree = {
            ...
            var items = {
                edit: {
                    ...
                    action: function (data) {
                        ...
                        //updateModal.open({id: node.id})
                        location.href = 'ContentBoxes/Update/' + node.id;
                    }
                },
                ...
                addSubMenuItem: {
                    ...
                    icon: 'fa fa-plus',
                    _disabled: !abp.auth.isGranted('CmsKit.ContentBoxes.Update'),
                    action: function () {
                ...
                'delete': {
                    ...
                    action: function (data) {
                        ...
                        abp.message.confirm(
                            l('ContentBoxDeletionConfirmationMessage', node.original.displayName),
                            l('AreYouSure'),
        ...
        addItem: function (parentId) {
            ...
            location.href = 'ContentBoxes/Create/' + parentId;
            //createModal.open({
            //    parentId: parentId,
        ...
        generateTextOnTree: function (item) {
            ...
            return '<span title="' + item.title + '" class="ou-text text-dark' + itemClass + '" data-menuitem-id="' + item.id + '">' +
                $.fn.dataTable.render.text().display(item.title) +
            ...
            menuService.getList({
                ...
                var treeData = _.map(result.items, function (item) {
                    return {
                        ...
                        displayName: $.fn.dataTable.render.text().display(item.title),
        ...
        init: function () {
            menuTree.getTreeDataFromServer(function (treeData) {
                ...
                $('button[name=CreateContentBox]').click(function (e) {
                    e.preventDefault();
                    //createModal.open();
