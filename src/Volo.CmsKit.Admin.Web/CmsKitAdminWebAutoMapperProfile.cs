...
public class CmsKitAdminWebAutoMapperProfile : Profile
{
    ...
    protected virtual void CreateGalleryImageMappings()
    {
        CreateMap<Volo.CmsKit.Admin.Web.Pages.CmsKit.GalleryImages.CreateModalModel.GalleryImageCreateViewModel, GalleryImageCreateUpdateDto>().MapExtraProperties();
       // CreateMap<Volo.CmsKit.Admin.Web.Pages.CmsKit.GalleryImages.EditModalModel.GalleryImageEditViewModel, CreateUpdateGalleryImageDto>().MapExtraProperties();
        //CreateMap<GalleryImageDto, Volo.CmsKit.Admin.Web.Pages.CmsKit.GalleryImages.EditModalModel.GalleryImageEditViewModel>().MapExtraProperties();
    }

    protected virtual void CreateBoxMappings()
    {
