...
public class MongoBlogPostRepository : MongoDbRepository<CmsKitMongoDbContext, BlogPost, Guid>, IBlogPostRepository
{
    ...
    public Task<List<BlogPost>> GetListWithOutContentAsync(string filter = null, Guid? blogId = null, Guid? authorId = null, string tagName = null, BlogPostStatus? statusFilter = null, int maxResultCount = int.MaxValue, int skipCount = 0, string sorting = null, CancellationToken cancellationToken = default)
    {
