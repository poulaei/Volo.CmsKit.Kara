...
public static class CmsKitDbContextModelCreatingExtensions
{
        ...
        this ModelBuilder builder)
    {
        ...
        if (GlobalFeatureManager.Instance.IsEnabled<GalleryImageFeature>())
        {
            ...
            {
                b.ToTable(AbpCmsKitDbProperties.DbTablePrefix + "Images", AbpCmsKitDbProperties.DbSchema);
                b.ConfigureByConvention();
                b.Property(x => x.Description).IsRequired().HasMaxLength(GalleryImageConsts.MaxDescriptionLength);
            });

        }
        else
        {
            builder.Ignore<GalleryImage>();
        }
        ...
        if (GlobalFeatureManager.Instance.IsEnabled<BoxFeature>())
        {
            ...
            {
                b.ToTable(AbpCmsKitDbProperties.DbTablePrefix + "Box", AbpCmsKitDbProperties.DbSchema);
                b.ConfigureByConvention();
            ...
            {
                b.ToTable(AbpCmsKitDbProperties.DbTablePrefix + "BoxItems", AbpCmsKitDbProperties.DbSchema);
                b.ConfigureByConvention();
            ...
            builder.Ignore<Box>();
            builder.Ignore<BoxItem>();
        }

        if (GlobalFeatureManager.Instance.IsEnabled<ContentBoxFeature>())
        {
            builder.Entity<ContentBox>(b =>
            {
                b.ToTable(AbpCmsKitDbProperties.DbTablePrefix + "ContentBox", AbpCmsKitDbProperties.DbSchema);
                b.ConfigureByConvention();
                b.Property(x => x.ParentId);
                b.Property(x => x.Section).IsRequired().HasMaxLength(ContentBoxConsts.SectionMaxLength);
                b.Property(x => x.BoxType).HasMaxLength(ContentBoxConsts.BoxTypeMaxLength);
                b.Property(x => x.BoxName).HasMaxLength(ContentBoxConsts.BoxNameMaxLength);
                b.Property(x => x.Content).HasMaxLength(ContentBoxConsts.ContentMaxLength);
                b.Property(x => x.Title).HasMaxLength(ContentBoxConsts.TitleMaxLength);
                b.Property(x => x.ActionType).HasMaxLength(ContentBoxConsts.ActionMaxLength);
                b.Property(x => x.Action).HasMaxLength(ContentBoxConsts.ActionMaxLength);
                b.Property(x => x.ActionUrl).HasMaxLength(ContentBoxConsts.ActionUrlMaxLength);
                b.Property(x => x.Summary).HasMaxLength(ContentBoxConsts.SummaryMaxLength);
                b.Property(x => x.Icon).HasMaxLength(ContentBoxConsts.IconMaxLength);
                b.Property(x => x.Description).HasMaxLength(ContentBoxConsts.DescriptionMaxLength);
                b.Property(x => x.MediaId);
                //b.HasIndex(x => new { x.Section, x.Status });
