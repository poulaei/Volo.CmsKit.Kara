...
namespace Volo.CmsKit.Migrations
{
    ...
    [Migration("20240705131209_Update-ContentBox-Changed-BoxNameMaxLength")]
    partial class UpdateContentBoxChangedBoxNameMaxLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Volo.CmsKit.Boxes.Box", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CmsBox", (string)null);
                });

            modelBuilder.Entity("Volo.CmsKit.Boxes.BoxItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CmsBoxItems", (string)null);
                });
            ...
            modelBuilder.Entity("Volo.CmsKit.ContentBoxes.ContentBox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CmsContentBox", (string)null);
                });

            modelBuilder.Entity("Volo.CmsKit.GalleryImages.GalleryImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CmsImages", (string)null);
                });
            ...
            modelBuilder.Entity("Volo.CmsKit.Boxes.BoxItem", b =>
                {
                    b.HasOne("Volo.CmsKit.Boxes.Box", null)
                        .WithMany("BoxItems")
                        .HasForeignKey("BoxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
